...
forenames = {
	"viking": [
		...
		"Yngvarr", "Simøn", "Lúis"],
	"english":
		['Botwulf', 'Cola', 'Eadberht', 'Eadræd', 'Eadwald', 
...
surnames = {
	"viking": 
		['Aghison', 'Agmundrson', 'Agnarrson', 'Agnison', 'Ákison', 
		'Áleifrson', 'Alfarrson', 'Alfríkrson', 'Alfvinson', 'Algautrson', 
		'Anundrson', 'Arison', 'Arnfinnrson', 'Árnison', 'Árnison', 'Arnórrson', 
		'Arnsteinnson', 'Arnþórrson', 'Arnviðrson', 'Ásbjǫrnson', 'Ásgeirrson', 
		'Ásketillson', 'Áskeladdson', 'Ásmundrson', 'Ásvaldrson', 'Aðalsteinnson', 
		'Auðrson', 'Auðunson', 'Baggison', 'Bárðrson', 'Birgirson', 'Bjarnison', 
		'Bjartrson', 'Bjǫrnson', 'Brandrson', 'Bróðirson', 'Brynjarrson', 'Búison', 
		'Dagfinnrson', 'Dagrson', 'Danrson', 'Egillson', 'Eileifrson', 'Einarrson', 
		'Eindriðison', 'Eiríkrson', 'Erlendrson', 'Erlingrson', 'Eysteinnson', 
		'Eyvindrson', 'Fastúlfrson', 'Félagison', 'Finnrson', 'Flæmingrson', 
		'Fólkison', 'Friðþjófrson', 'Fróðison', 'Gautison', 'Gautstafrson', 
		'Geirmundrson', 'Geirrson', 'Gulbrandrson', 'Gunnarrson', 'Gunnison', 
		'Gunnvaldrson', 'Guðbrandrson', 'Guðfrøðrson', 'Guðinison', 'Guðleifrson', 
		'Guðmundrson', 'Guðormrson', 'Guðrøðrson', 'Hákonson', 'Hálfdanson', 
		'Hallbjǫrnson', 'Hallison', 'Hallrson', 'Hallsteinnson', 'Hallþórrson', 
		'Hallvarðrson', 'Hámundrson', 'Haraldrson', 'Harðaknútrson', 'Hávarðrson', 
		'Helgison', 'Hemingson', 'Herleifrson', 'Hilddingrson', 'Hjálmarrson', 'Hólmgeirrson', 
		'Hrafnson', 'Hreiðarrson', 'Hróaldrson', 'Hróarrson', 'Hrœrekrson', 'Hrólfrson', 
		'Hrǿríkrson', 'Hróðgeirrson', 'Hróðulfrson', 'Hugleikrson', 'Ingison', 'Ingimárrson', 
		'Ingólfrson', 'Ívarrson', 'Jarlson', 'Jóarrson', 'Jósteinnson', 'Kálfrson', 'Kárison', 
		'Karlson', 'Ketillson', 'Knútrson', 'Kolrson', 'Kórison', 'Leifrson', 'Magnison', 
		'Mundison', 'Njállson', 'Oddbjǫrnson', 'Oddgeirrson', 'Oddrson', 'Oddvarrson', 
		'Ǫlvirson', 'Óttarrson', 'Ragnarrson', 'Ragnvaldrson', 'Randúlfrson', 'Ráðúlfrson', 
		'Rúnison', 'Sigfrøðrson', 'Sigmundrson', 'Sigsteinnson', 'Sigurðrson', 'Sindrison', 
		'Snorrison', 'Sǫlvison', 'Somerledson', 'Stálison', 'Steinarrson', 'Steingrímrson', 
		'Steinnson', 'Stígandrson', 'Stigrson', 'Sumarliðison', 'Sundrison', 'Sunison', 
		'Sveinnson', 'Sverrirson', 'Tórarinnson', 'Tórbjǫrnson', 'Tórfastrson', 'Torfinnson', 
		'Tórfreðrson', 'Tórgeirrson', 'Tórgíslson', 'Tórgnýrson', 'Tórgrímrson', 'Tórirson', 
		'Tórketillson', 'Tórleifrson', 'Tórleikrson', 'Tórmóðrson', 'Tórsteinnson', 'Tórðrson', 
		'Tórvaldrson', 'Tróndrson', 'Tófison', 'Tókison', 'Tryggvison', 'Úlfrson', 'Unison', 
		'Vagnson', 'Valdimárrson', 'Valþjófrson', 'Vébjǫrnson', 'Végarðrson', 'Vetrliðison', 
		'Vígison', 'Víkingrson', 'Vragison', 'Yngvarrson', 'Simønson', 'Lúisson'],
	"english": 
